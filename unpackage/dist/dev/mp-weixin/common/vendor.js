...
function initData(vueOptions, context) {
  ...
  if (typeof data === 'function') {
    try {
      ...
      if (Object({"VUE_APP_NAME":"music-WY","VUE_APP_PLATFORM":"mp-weixin","NODE_ENV":"development","BASE_URL":"/"}).VUE_APP_DEBUG) {
...
/* 5 */
/*!******************************************!*\
  !*** D:/项目总结/uniapp/music-WY/pages.json ***!
  \******************************************/
/*! no static exports found */
/***/ (function(module, exports) {
...
/* 12 */
/*!**********************************************!*\
  !*** D:/项目总结/uniapp/music-WY/store/index.js ***!
  \**********************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/* 14 */
/*!*****************************************************!*\
  !*** D:/项目总结/uniapp/music-WY/iconfont/iconfont.css ***!
  \*****************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/* 24 */
/*!**********************************************!*\
  !*** D:/项目总结/uniapp/music-WY/network/api.js ***!
  \**********************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
/* WEBPACK VAR INJECTION */(function(uni) {Object.defineProperty(exports, "__esModule", { value: true });exports.getTopList = getTopList;exports.getTopListItem = getTopListItem;exports.songDetail = songDetail;exports.songSimi = songSimi;exports.songComment = songComment;exports.songLyric = songLyric;exports.songUrl = songUrl;exports.hotMusic = hotMusic;exports.searchWord = searchWord;exports.searchSuggest = searchSuggest;
var _config = __webpack_require__(/*! ./config.js */ 25); // 使用路径发起请求的文件
...
function songDetail(ids) {
  return uni.request({
    url: "".concat(_config.baseUrl, "/song/detail?ids=").concat(ids),
    method: 'GET' });

}

//获取相似歌曲
function songSimi(simiId) {
  return uni.request({
    url: "".concat(_config.baseUrl, "/Simi/song?id=").concat(simiId),
    method: 'GET' });

}

//获取歌曲评论
function songComment(commentId) {
  return uni.request({
    url: "".concat(_config.baseUrl, "/comment/music?id=").concat(commentId),
    method: 'GET' });

}

//获取歌词
function songLyric(lyricId) {
  return uni.request({
    url: "".concat(_config.baseUrl, "/lyric?id=").concat(lyricId),
    method: 'GET' });

}

//获取歌曲路径
function songUrl(songUrlId) {
  return uni.request({
    url: "".concat(_config.baseUrl, "/song/url?id=").concat(songUrlId),
    method: 'GET' });
...
/* 25 */
/*!*************************************************!*\
  !*** D:/项目总结/uniapp/music-WY/network/config.js ***!
  \*************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.baseUrl = void 0; //公共的请求路径
